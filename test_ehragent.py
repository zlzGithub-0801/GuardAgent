...
import argparse
import autogen
from toolset_high_ehr import run_code, llm_agent
...
def main():
    ...
    parser.add_argument("--data_path", type=str, default="data/eicu/valid_preprocessed.json")
    ...
    file_path = "{}/".format(args.logs_path) + "{id}.txt"
